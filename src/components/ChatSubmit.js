        ...
        <>
            <form onSubmit={submitHandler}>
                <Grid container   alignItems={'center'} style={{padding:'10px'}}>
                    ...
                    <Grid item xs={10}  >     
                        <textarea ref={inputref} type="text" rows='1'  wrap="hard" onInput={inputHandler} style={{resize:'none',WebkitOverflowScrolling:'display:none', background:'#ECF3ED' , width:'100%' , marginTop:'5px',wordWrap:'break-word',padding:'10px 20px 10px 20px ',paddingLeft:'20px', border:'none', borderRadius:'999px' ,color:'#ECF3ED',  outline:'0' , color:'black'}} placeholder='Type something'></textarea>             
                    </Grid>
                    <Grid item >
